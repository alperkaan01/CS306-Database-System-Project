...
<img src="../../imgs/images-removebg-preview.png" alt="Olympics" class="olympic-img">
    ...
    <div class='Container'>
        ...
        <form action="insertCompetition.php" method="POST">  
            <p class='sport-p'>
            Sport:
            </p>
            <p class='round-p'>
            ...
            <textarea id="competitor_id" name="competitor_id" rows="4" cols="20" placeholder="One ID at each line"></textarea>
